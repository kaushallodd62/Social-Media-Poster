...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, showPasswordToggle, icon, className = '', type = 'text', ...props }, ref) => {
    ...
    const baseClasses = `
      ...
      ${error 
        ? 'border-red-300 dark:border-red-700 text-red-900 dark:text-red-200 placeholder-red-300 dark:placeholder-red-400 focus:ring-red-500 focus:border-red-500' 
